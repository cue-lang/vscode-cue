...
workflows: trybot: _repo.bashWorkflow & {
	...
	jobs: test: {
		...
		steps: [
			...
			// Update PATH to allow for vsce and other npm-installed CLIs to be
			// usable. Do this for the root level tooling package.json, and the
			// extension-specific package.json
			githubactions.#Step & {
