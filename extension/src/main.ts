...
// extension in an instance of the Instance class. We will later work out how
...
// ========================
// The class arrow field function style of declaring methods in the Instance
...
// extension. An instance of Instance is then created to wrap the context for
...
export async function activate(context: vscode.ExtensionContext): Promise<void> {
	...
	// An instance of Instance represents the active extension instance, in this
	// VSCode window.
	inst = new Instance(context, output, lspOutput);
}
