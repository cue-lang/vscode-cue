...
export class Extension {
	...
	//
	// Because the return type of this method is void, we need to determine how
	// to report errors to the user. Hence we either use showErrorMessage or
	// this.output.error, with a mild preference for the former because it surfaces
