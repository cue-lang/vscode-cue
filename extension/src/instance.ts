...
let errTornDown = new Error('Instance already torn down');

// An instance of Instance (!!) represents the active instance (!!) of the
// VSCode extension that is this project. An instance of Instance is created
// when the extension is activated, and tearDown-ed when the extension is
// deactivated.
export class Instance {
	...
	// tornDown is set to true only when this Instance is being tearDown-ed. This
	// happens when the corresponding extension instance has been deactivate-d.
	// This state allows us to be defensive in callback methods, throwing errors
	// in case we get callbacks after tearDown.
